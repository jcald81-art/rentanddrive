...
export default function CarfidelityInspectionPage() {
  ...
  async function downloadPDF() {
    ...
    try {
      ...
      doc.text('Generated by Inspector Cartegrity AI | carfidelity.ai | Rent and Drive LLC', 20, 280)
  ...
  function shareReport() {
    ...
    if (navigator.share) {
      navigator.share({
        title: `carfidelity.ai Report ${reportId}`,
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800 bg-black/95 backdrop-blur">
        <div className="flex h-14 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <div>
<span className="font-bold text-[#CC0000]">carfidelity.ai</span>
  <p className="text-[10px] text-zinc-500 -mt-1">Inspector Cartegrity AI | Vehicle Integrity. Verified.</p>
            </div>
          </div>
          <Badge 
            className={type === 'PRE' 
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              <CardContent className="pt-4">
                <p className="text-sm text-zinc-400">
                  ...
                  Inspector Cartegrity AI will analyze each photo for damage in real-time.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  {isAnalyzing ? (
                    <div className="bg-black/80 backdrop-blur rounded-xl p-8 text-center">
                      ...
                      <p className="text-white text-lg font-semibold">Inspector Cartegrity analyzing...</p>
                    </div>
                  ) : analysisResult && (
        ...
        {screen === 'complete' && (
          <div className="p-4 space-y-6 text-center">
            ...
            <p className="text-xs text-zinc-600 pt-4">
              Powered by Inspector Cartegrity AI | carfidelity.ai | Rent and Drive LLC
            </p>
          </div>
        )}
      </main>
