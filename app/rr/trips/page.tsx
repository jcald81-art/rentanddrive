  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      setBookings({
        ...
        past: [
          { id: '3', start_date: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(), end_date: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), status: 'completed', total_price: 267, pickup_address: '789 Pine St, Sparks, NV', vehicle: mockVehicle, has_review: false, cartegrity_report_id: 'CART-20240115-001' },
