        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Complete pre-trip and post-trip inspektlabs.ai inspections as required</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Complete pre-trip and post-trip inspektlabs.ai inspections honestly and accurately</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">4. RAD Inspektlabs Inspection Requirement</h2>
            <p>
              All rentals require completion of our RAD Inspektlabs inspection process. 
