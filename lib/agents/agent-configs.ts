...
export const AGENT_CONFIGS: Record<string, AgentConfig> = {
  'rad-comms': {
    id: 'rad-comms',
    name: 'RAD Comms',
    role: 'Communications Lead (ARCHIVED)',
    initials: 'RC',
    color: '#666666',
    textColor: '#999999',
    task_type: 'communications',
    description: 'ARCHIVED: This agent has been decommissioned. Communications are now handled by the main RAD agent.',
    status: 'staged',
    staged_reason: 'ARCHIVED: rad-comms has been decommissioned and replaced by the unified RAD Command Center AI. All communications functionality is now handled by the main RAD agent.',
  },
  'rad-pricing': {
    id: 'rad-pricing',
    name: 'RAD Pricing',
