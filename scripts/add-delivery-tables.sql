-- ============================================================
-- RentAndDrive — Delivery & Inspection Tables Migration
-- ============================================================
-- Adds: deliveries, inspections (enhanced), and delivery_status_log
-- These tables are linked to bookings and vehicles.
-- ============================================================

-- --------------------------------------------------------
-- Delivery records table (Lyft Concierge + Uber Direct)
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS deliveries (
  ...
  -- Driver info (live from Lyft/Uber)
  driver_name TEXT,
  driver_phone TEXT,
...
-- --------------------------------------------------------
-- Delivery status change log (full audit trail)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- Vehicle inspections (enhanced for Inspektlabs)
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS vehicle_inspections (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  booking_id UUID REFERENCES bookings(id) ON DELETE SET NULL,
  vehicle_id UUID NOT NULL REFERENCES vehicles(id),
  performed_by UUID REFERENCES profiles(id), -- null = renter self-inspection
  ...
  inspection_link TEXT, -- sent to renter
...
-- Deliveries: renters can view their own deliveries
...
-- Vehicle inspections: vehicle owners and renters can view
...
-- Delivery status log: follow parent delivery permissions
