...
VALUES
  ...
  ('Badge', 'Diesel', 'driver_verification', 'openai/gpt-4o', 'google/gemini-2.5-pro', 'anthropic/claude-sonnet-4-20250514', false, 'Driver verification and CarFidelity certification', true, false, 0, 'badge-check', '#10B981', 'Driver Verification'),
